...
\documentclass[a4paper,11pt,bibtotoc,twoside,openright,pointlessnumbers,normalheadings,DIV=15,BCOR25mm
%,draft
]{scrbook}
...
\newcommand{\fullname}{René Trampenau}
\newcommand{\email}{trampena@mail.hs-ulm.de}
\newcommand{\titel}{Entwicklung und Realisierung einer modularen Klimaregelung auf Klimamodell-Basis}
%\newcommand{\titel}{Titel der Arbeit}
\newcommand{\jahr}{2014}
\newcommand{\matnr}{3114191}
\newcommand{\gutachterA}{Prof.~Dr.~Streng Geheim}
\newcommand{\gutachterB}{Prof.~Dr.~Un Leserlich}
\newcommand{\betreuer}{Dipl.-Inf. Thomas Giese}
% hier richtige Fakultät auswählen
\newcommand{\fakultaet}{Systems Engineering and Management\\Electrical Engineering}
...
{\footnotesize Master Thesis an der Hochschule Ulm}\\[3em]
